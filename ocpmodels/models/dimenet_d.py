...
from ocpmodels.models.processing_pygraph import get_dop_edges, get_edge_batch


@registry.register_model("dimenet_dop")
class DimeNetDopWrap(DimeNet):
    ...
    def __init__(
        ...
        super(DimeNetDopWrap, self).__init__(
    ...
    def _forward(self, data):
        ...
        for interaction_block, output_block in zip(
            ...
            x_dop_mean = scatter(x_dop, dop_edge_batch_ids.to('cuda:0'), dim=0, reduce='mean')
            x_dop_repeat = x_dop_mean.repeat_interleave(edge_batch.to('cuda:0'), dim=0)
            x = x + x_dop_repeat
